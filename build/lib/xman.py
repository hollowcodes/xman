...
class ExperimentManager:
    def __init__(self, experiment_name: str="0", new: bool=False, continue_: bool=False):
        ...
        # check for conflict: 'new' wants to create a new experiment, 'continue_' want to work with current
        if self.new and self.continue_:
            raise ValueError("'new' and 'continue_' can't both be True.")
